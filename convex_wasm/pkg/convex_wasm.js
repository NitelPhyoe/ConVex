...
* @returns {string}
*/
export function compress_data_with_filename(data, filename) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.compress_data_with_filename(retptr, ptr0, len0, ptr1, len1);
...
* @returns {any}
*/
export function decompress_data_with_filename(compressed_base64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(compressed_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.decompress_data_with_filename(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('convex_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
